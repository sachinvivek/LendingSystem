...
contract PeerToPeerLending is Destructible {
    ...
    /** @dev Constructor */
    function _PeerToPeerLending() public {
    ...
    /** @dev Get the list with all credits.
      ...
      */
    function getCredits() public view returns (address[] allCredits) {
        return credits;
    }
    ...
    /** @dev Get all users credits.
      ...
      */
    function getUserCredits() public view returns (address[] allCredits) {
